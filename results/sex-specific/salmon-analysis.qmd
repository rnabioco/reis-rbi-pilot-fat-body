...
ggplot(
  ...
  labs(
    title = 'PCA analysis of FB / Brain RNA-seq samples',
...
So, a lot of the top genes are "expressed in spermatozoon", possibly indicating contamination of the fat body tissue with gonadal tissue and plausibly accounting for the major differences in expression between male and female FB tissue.
